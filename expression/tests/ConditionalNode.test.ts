...
describe('ConditionalNode - construction & identity', () => {
  ...
  it('has correct type property', () => {
    expect(new ConditionalNode(makeConst(1), makeConst(2), makeConst(3)).type).toBe('ConditionalNode')
  })

  it('has isConditionalNode = true', () => {
    expect(new ConditionalNode(makeConst(1), makeConst(2), makeConst(3)).isConditionalNode).toBe(true)
  })
