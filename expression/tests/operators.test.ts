...
import { properties, getPrecedence, getAssociativity, isAssociativeWith, getOperator } from '../src/operators.js'
...
function opNode(fn: string, args: any[] = [], implicit = false) {
  return {
    ...
    args,
    implicit,
    getIdentifier() { return `OperatorNode:${fn}` },
...
function constantNode(value: any) {
  return {
    ...
    isConstantNode: true,
    value,
    getIdentifier() { return 'ConstantNode' },
    getContent() { return this }
  }
}
...
function symbolNode(name: string) {
  return {
    ...
    isSymbolNode: true,
    name,
    getIdentifier() { return 'SymbolNode' },
    getContent() { return this }
  }
}
...
function relationalNode() {
  return {
    ...
    getIdentifier() { return 'RelationalNode' },
    getContent() { return this }
  }
}
...
function assignmentNode() {
  return {
    ...
    getIdentifier() { return 'AssignmentNode' },
    getContent() { return this }
  }
}
...
function conditionalNode() {
  return {
    ...
    getIdentifier() { return 'ConditionalNode' },
    getContent() { return this }
  }
}
...
function parenthesisNode(inner: any) {
  return {
    ...
    content: inner,
    getIdentifier() { return 'ParenthesisNode' },
    getContent() { return inner }
  }
}
...
describe('getPrecedence', () => {
  ...
  it('returns null for an unknown node type', () => {
    const node = {
      type: 'UnknownNode',
      getIdentifier() { return 'UnknownNode' },
      getContent() { return this }
    }
    const prec = getPrecedence(node, 'auto', 'hide', null)
