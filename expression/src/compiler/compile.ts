 ...
 */
function compileNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
...
function compileSymbolNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
...
function compileOperatorNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
...
function compileFunctionNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
  const evalArgs: EvalFunction[] = node.args.map((arg: any) => compileNode(arg, math, argNames))
  ...
  if (fnNode && fnNode.isSymbolNode) {
    ...
    switch (evalArgs.length) {
      case 0:
        return function evalFunctionNode(scope: Scope, args: Record<string, any>, _context: any) {
...
function compileArrayNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
  const evalItems: EvalFunction[] = node.items.map((item: any) => compileNode(item, math, argNames))
  return function evalArrayNode(scope: Scope, args: Record<string, any>, context: any) {
    return evalItems.map(e => e(scope, args, context))
  }
}

function compileAssignmentNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
...
function compileBlockNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
...
function compileConditionalNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
...
function compileObjectNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
...
function compileRangeNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
...
function compileRelationalNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
  const compiled: EvalFunction[] = node.params.map((p: any) => compileNode(p, math, argNames))
  const conditionals: string[] = node.conditionals

  return function evalRelationalNode(scope: Scope, args: Record<string, any>, context: any): boolean {
    let evalLhs: any
...
function compileFunctionAssignmentNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
  ...
  return function evalFunctionAssignmentNode(scope: Scope, args: Record<string, any>, _context: any) {
...
function compileAccessorNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
...
function compileIndexNode(node: any, math: Record<string, any>, argNames: Record<string, boolean>): EvalFunction {
  const evalDimensions: EvalFunction[] = node.dimensions.map((dim: any) => compileNode(dim, math, argNames))
