...
- 8b0f960: `ComputePool` honours its per-op thresholds (`thresholdByOp`) for every method, and a partial override keeps the other defaults.
...
- Updated dependencies [a13ce7e]
  ...
  - @danielsimonjr/mathts-workerpool@0.2.5
...
- Updated dependencies [57c8ffd]
  ...
  - @danielsimonjr/mathts-workerpool@0.2.2
