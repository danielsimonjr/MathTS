...
- 8b0f960: Type fixes that let callers pass real implementations without casts. There is no runtime change.
...
- ecdc79a: Fix the published `dist/map.d.ts` for consumers that compile with `skipLibCheck: false`.
