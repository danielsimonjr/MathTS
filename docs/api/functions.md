...
**Arithmetic** (44): `abs`, `add`, `addScalar`, `cbrt`, `ceil`, `clamp`, `cube`, `divide`, `divideScalar`, `dot`, `dotDivide`, `dotMultiply`, `dotPow`, `exp`, `expm1`, `fix`, `floor`, `gcd`, `invmod`, `lcm`, `log`, `log10`, `log1p`, `log2`, `matmul`, `matvec`, `mod`, `multiply`, `multiplyScalar`, `norm`, `nthRoot`, `nthRoots`, `outer`, `pow`, `round`, `sigmoid`, `sign`, `sqrt`, `square`, `subtract`, `subtractScalar`, `unaryMinus`, `unaryPlus`, `xgcd`
