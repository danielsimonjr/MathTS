...
|---------|-------------|-------------|-------|---------|
| `@mathts/typed-function` | Type dispatch system (forked) | 2 | 1 | 53 |
| `@mathts/workerpool` | Worker pool management (forked) | 3 | 1 | 29 |
| `@mathts/core` | Types, typed-function, factory | 95 | 12 | 625 |
| `@mathts/matrix` | DenseMatrix, SparseMatrix, backends | 33 | 14 | 305 |
| `@mathts/functions` | Math functions via typed dispatch | 750 | 9 | 3,564 |
| `@mathts/parallel` | ComputePool, WebWorker operations | 14 | 10 | 162 |
| `@mathts/expression` | Parser/evaluator (stubs for compiler) | 331 | 0 | 528 |
| `@mathts/workbook` | .mtsw notebook runtime + CLI | 6 | 3 | 29 |
| `@mathts/compat` | mathjs compatibility shim | 3 | 2 | 132 |
...
| Assembly | Builds | 432 WASM exports, AssemblyScript compiles successfully |
