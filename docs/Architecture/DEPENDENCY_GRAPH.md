...
| `@danielsimonjr/mathts-functions` (`functions/`)                    | `@danielsimonjr/mathts-matrix`, `@danielsimonjr/mathts-core`, `@danielsimonjr/mathts-expression`, `@danielsimonjr/mathts-gpu`, `@danielsimonjr/mathts-parallel` | 433            | 2               |
...
| `./geometry/geometry-extra.js` | `quaternionInverse, quaternionSlerp, quaternionToEuler, boundingBox, procrustes, kdTreeKNN, kdTreeRadius, setIsSuperset, setEqual, setDisjoint` | Re-export |
...
- Functions: `quaternionInverse`, `quaternionSlerp`, `quaternionToEuler`, `boundingBox`, `procrustes`, `kdTreeKNN`, `kdTreeRadius`, `setIsSuperset`, `setEqual`, `setDisjoint`
...
| `functions/src/index`                                  | 57 files     | 0 files    |
...
graph TD
    ...
    subgraph Functions/gpu
        N152[elementwise-gpu]
        N153[fft-gpu]
    end

    subgraph Functions/graph
        N154[optimization]
        N155[traversal-centrality]
    end
    ...
    subgraph Functions/ml
        N172[dbscan-knn]
        N173[kde]
        N174[logistic-regression]
        N175[ols]
        N176[regularized-regression]
    end
    ...
    subgraph Functions/numeric
        N178[adaptive-quad]
        N179[bfgs]
        N180[control-equations]
        N181[eigsh]
        N182[fsolve]
        N183[gauss-nodes]
        N184[interpn]
        N185[krylov]
        N186[matrix-functions]
        N187[minimize-scalar]
        N188[...5 more]
    end
    ...
    subgraph Functions/set
        ...
        N224[setIntersect]
        N225[setIsSubset]
        N226[setMultiplicity]
        N227[setPowerset]
        N228[setSize]
        N229[setSymDifference]
        N230[setUnion]
    end
    ...
    subgraph Functions/special
        N241[erf]
        N242[hypergeometric]
        N243[jacobi-elliptic]
        N244[polygamma-orthopoly]
        N245[zeta]
    end
    ...
    subgraph Functions/stats
        N257[fit-distribution]
        N258[inference-extra]
        N259[inference-extra2]
        N260[timeseries]
    end
    ...
    subgraph Expression/node
        ...
        N351[AssignmentNode]
        N352[BlockNode]
        N353[ConditionalNode]
        N354[ConstantNode]
        N355[FunctionAssignmentNode]
        N356[FunctionNode]
        N357[IndexNode]
        N358[Node]
        N359[...8 more]
    ...
    subgraph Expression/transform
        N360[and.transform]
        N361[bitAnd.transform]
        N362[bitOr.transform]
        N363[column.transform]
        N364[concat.transform]
        N365[cumsum.transform]
        N366[diff.transform]
        N367[filter.transform]
        N368[forEach.transform]
        N369[index.transform]
        N370[...21 more]
    end
...
| Category                | Count  |
| ----------------------- | ------ |
| Total TypeScript Files  | 1066   |
| Total Modules           | 82     |
| Total Lines of Code     | 182120 |
| Total Exports           | 5322   |
| Total Re-exports        | 1996   |
| Total Classes           | 56     |
