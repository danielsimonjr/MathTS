...
| `@danielsimonjr/mathts-functions` (`functions/`)                    | `@danielsimonjr/mathts-matrix`, `@danielsimonjr/mathts-core`, `@danielsimonjr/mathts-expression`, `@danielsimonjr/mathts-gpu`, `@danielsimonjr/mathts-parallel` | 453            | 2               |
...
- Functions: `rosenbrockSolve`, `rodasSolve`, `bdfSolve`, `radauSolve`
...
- Re-exports: `solveParabolicPDE`, `SolveParabolicPDEOptions`, `ParabolicPDESolution`, `ParabolicBC`, `SpaceCoefficient`, `BoundaryDatum`, `ParabolicSource`
...
| `functions/src/index`                                  | 76 files     | 0 files    |
...
graph TD
    ...
    subgraph Functions/geometry
        ...
        N157[intersect]
        N158[intersect3d]
        N159[spherical-voronoi]
        N160[voronoi]
    end

    subgraph Functions/gpu
        N161[elementwise-gpu]
        N162[fft-gpu]
    end

    subgraph Functions/graph
        N163[community-coloring]
        N164[optimization]
        N165[traversal-centrality]
    end
    ...
    subgraph Functions/ml
        ...
        N183[glm]
        N184[kde]
        N185[logistic-regression]
        N186[ols]
        N187[regularized-regression]
    end
    ...
    subgraph Functions/set
        ...
        N235[setIntersect]
        N236[setIsSubset]
        N237[setMultiplicity]
        N238[setPowerset]
        N239[setSize]
        N240[setSymDifference]
        N241[setUnion]
    end
    ...
    subgraph Functions/special
        N253[erf]
        N254[hypergeometric]
        N255[jacobi-elliptic]
        N256[niche]
        N257[polygamma-orthopoly]
        N258[wave-functions]
        N259[zeta]
    end
    ...
    subgraph Functions/stats
        N271[fit-distribution]
        N272[gaussian-process]
        N273[inference-extra]
        N274[inference-extra2]
        N275[multivariate-sampling]
        N276[mvn]
        N277[power-analysis]
        N278[timeseries]
    end
    ...
    subgraph Expression/node
        ...
        N367[AssignmentNode]
        N368[BlockNode]
        N369[ConditionalNode]
        N370[ConstantNode]
        N371[FunctionAssignmentNode]
        N372[FunctionNode]
        N373[IndexNode]
        N374[Node]
        N375[...8 more]
    ...
    subgraph Expression/transform
        N376[and.transform]
        N377[bitAnd.transform]
        N378[bitOr.transform]
        N379[column.transform]
        N380[concat.transform]
        N381[cumsum.transform]
        N382[diff.transform]
        N383[filter.transform]
        N384[forEach.transform]
        N385[index.transform]
        N386[...21 more]
    end
...
| Category                | Count  |
| ----------------------- | ------ |
| Total TypeScript Files  | 1100   |
| Total Modules           | 82     |
| Total Lines of Code     | 188508 |
| Total Exports           | 5644   |
| Total Re-exports        | 2286   |
| Total Classes           | 52     |
