...
graph TD
    ...
    subgraph Functions/bitwise
        ...
        N108[bitXor]
        N109[leftShift]
        N110[rightArithShift]
        N111[rightLogShift]
        N112[useMatrixForArrayScalar]
    end

    subgraph Functions
        N113[calculus-extra]
        N114[cas-integration]
        N115[clustering-extra]
        N116[descriptive-stats]
        N117[distribution-functions]
        N118[geometry-extra]
        N119[grad-forward]
        N120[help]
        N121[hypothesis-extra]
        N122[index]
        N123[...7 more]
    end
    ...
    subgraph Functions/set
        ...
        N200[setIntersect]
        N201[setIsSubset]
        N202[setMultiplicity]
        N203[setPowerset]
        N204[setSize]
        N205[setSymDifference]
        N206[setUnion]
    end
    ...
    subgraph Expression/node
        ...
        N312[AssignmentNode]
        N313[BlockNode]
        N314[ConditionalNode]
        N315[ConstantNode]
        N316[FunctionAssignmentNode]
        N317[FunctionNode]
        N318[IndexNode]
        N319[Node]
        N320[...8 more]
