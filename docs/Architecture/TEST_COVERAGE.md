...
| Metric | Count |
|--------|-------|
| Total Source Files | 1247 |
| Total Test Files | 57 |
| Source Files with Tests | 64 |
| Source Files without Tests | 1183 |
| Coverage | 5.1% |
...
The following 1183 source files are not directly imported by any test file:
...
- `matrix/src/operations/index.ts` → Expected test: `tests/unit/src/index.test.ts`
