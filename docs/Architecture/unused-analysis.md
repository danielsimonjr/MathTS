...
- **Potentially unused exports**: 235
  - **Unreferenced anywhere (deletion candidates)**: 0
  - **Referenced in-module (type contracts / helpers backing live exports)**: 235
...
### `functions/src/descriptive-stats.ts`

- `LinRegressResult` (interface) — 1 in-file ref
- `CorrelationTestResult` (interface) — 3 in-file refs
- `DescribeResult` (interface) — 1 in-file ref
- `HistogramResult` (interface) — 1 in-file ref
