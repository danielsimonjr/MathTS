...
| [Architecture/FILE_INVENTORY.md](Architecture/FILE_INVENTORY.md)       | Complete file census — every `src/`+`tests/` `.ts` tagged reachable/build-entry/test-only/orphan/test (data: `file-inventory.json`; self-checked in `docs:deps`). |
