...
**Description**: Implement full SVD decomposition A = U _ S _ V^T
**Algorithms**:
...
**Description**: Spherical Bessel functions j*n(x)
**Relation**: j_n(x) = sqrt(π/2x) \* J*{n+1/2}(x)
**Interface**:
...
export function functionNameArray(input: Float64Array, output: Float64Array, length: i32): void {
...
_Target Completion: 15 sprints (150 days with 10 days/sprint)_
