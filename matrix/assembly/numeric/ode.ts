 ...
 */
export function vectorScale(vec: Float64Array, scale: f64, n: i32, result: Float64Array): void {
  for (let i: i32 = 0; i < n; i++) {
 ...
 */
export function vectorAdd(a: Float64Array, b: Float64Array, n: i32, result: Float64Array): void {
  for (let i: i32 = 0; i < n; i++) {
