...
"@mathts/core": patch
"@mathts/matrix": patch
"@mathts/functions": patch
"@mathts/parallel": patch
"@mathts/compat": patch
"@mathts/workbook": patch
"@mathts/expression": patch
"@mathts/wasm": patch
"@mathts/typed-function": patch
"@mathts/workerpool": patch
---

Fix all pre-existing build, typecheck, and configuration issues across the monorepo.
