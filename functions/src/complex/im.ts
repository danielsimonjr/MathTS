...
export const createIm = /* #__PURE__ */ factory(name, dependencies, ({ typed }: ImDependencies) => {
  /**
  ...
  return typed(name, {
    number: (): number => 0,
    'BigNumber | Fraction': (x: BigNumberType | FractionType): BigNumberType | FractionType =>
      x.mul(0),
