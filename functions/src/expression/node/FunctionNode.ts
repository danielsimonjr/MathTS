...
export const createFunctionNode = /* #__PURE__ */ factory(
  ...
  ({ math, Node, SymbolNode }: FunctionNodeDependencies) => {
     ...
     * @private
     */
    function expandTemplate(template: string, node: FunctionNode, options?: StringOptions): string {
      let latex = '';
    ...
    class FunctionNode extends Node {
       ...
       */
      _compile(math: MathNamespace, argNames: Record<string, boolean>): CompileFunction {
        // compile arguments
        ...
        if (isSymbolNode(this.fn)) {
          ...
          if (!argNames[fnName]) {
            ...
            const isRaw = typeof fn === 'function' && (fn as RawArgsFunction).rawArgs === true;
          ...
          return function evalFunctionNode(
            ...
            const object = evalObject(scope, args, context) as Record<string, unknown>;
