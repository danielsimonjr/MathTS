 ...
 * principle — keep the implementation in the standard layer, don't fork it). This file
 * is a thin re-export so existing `../utils/number.js` imports keep working while the
