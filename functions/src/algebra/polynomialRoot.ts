...
export const createPolynomialRoot = /* #__PURE__ */ factory(
  name,
  dependencies,
  ({
    typed,
        ...
        switch (coeffs.length) {
          ...
          case 4: {
            ...
            if (equalScalar(discriminant1, discriminant2)) {
              return [
                divide(
                  subtract(multiply(4, a, b, c), add(multiply(9, a, a, d), multiply(b, b, b))),
                  multiply(a, Delta0)
                ), // simple root
            ...
            if (equalScalar(D0_1, D0_2)) {
              ...
              Ccubed = divide(
                add(
                  Delta1,
                  sqrt(subtract(multiply(Delta1, Delta1), multiply(4, Delta0, Delta0, Delta0)))
                ),
                2
              );
            }
