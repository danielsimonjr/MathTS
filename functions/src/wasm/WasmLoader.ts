...
export interface WasmModule {
  ...
  // (see below); dispatch is AS→JS only.
  ...
  // AS-backend elementwise bitwise kernels — same semantics as the legacy
  // pointer-ABI fields above, distinct naming convention. These are the only
  // bitwise kernels dispatched today; the bridge gates on the AS sentinel and
  // falls back to JS when the loaded binary is not the AS one.
