 ...
 */
function solveLinear(aPtr: usize, bPtr: usize, n: i32, xPtr: usize, workPtr: usize): i32 {
  const luPtr = workPtr;
 ...
 * @returns 1 if successful, 0 if no unique solution
 */
export function lyap(aPtr: usize, n: i32, qPtr: usize, xPtr: usize, workPtr: usize): i32 {
  const n2: i32 = n * n;
  const n4: i32 = n2 * n2;
 ...
 * @returns 1 if successful, 0 if no unique solution
 */
export function dlyap(aPtr: usize, n: i32, qPtr: usize, xPtr: usize, workPtr: usize): i32 {
  const n2: i32 = n * n;
  const n4: i32 = n2 * n2;
 ...
 * @returns Frobenius norm of residual
 */
export function lyapResidual(aPtr: usize, n: i32, xPtr: usize, qPtr: usize, workPtr: usize): f64 {
  const n2: i32 = n * n;
  const axPtr = workPtr;
 ...
 * @returns Frobenius norm of residual
 */
export function dlyapResidual(aPtr: usize, n: i32, xPtr: usize, qPtr: usize, workPtr: usize): f64 {
  const n2: i32 = n * n;
  const axPtr = workPtr;
