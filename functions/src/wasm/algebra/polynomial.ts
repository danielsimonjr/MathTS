 ...
 */
export function polyEvalWithDerivative(coeffsPtr: usize, n: i32, x: f64, resultPtr: usize): void {
  if (n === 0) {
 ...
 */
export function polyMultiply(aPtr: usize, na: i32, bPtr: usize, nb: i32, resultPtr: usize): i32 {
