 ...
 */
export function setUnion(aPtr: usize, na: i32, bPtr: usize, nb: i32, resultPtr: usize): i32 {
 ...
 */
export function setIntersect(aPtr: usize, na: i32, bPtr: usize, nb: i32, resultPtr: usize): i32 {
  if (na === 0 || nb === 0) return 0;
 ...
 */
export function setDifference(aPtr: usize, na: i32, bPtr: usize, nb: i32, resultPtr: usize): i32 {
  if (na === 0) return 0;
  if (nb === 0) {
    for (let i: i32 = 0; i < na; i++) {
      const offset: usize = (<usize>i) << 3;
 ...
 */
export function setIsProperSubset(aPtr: usize, na: i32, bPtr: usize, nb: i32): i32 {
 ...
 */
export function setIsProperSuperset(aPtr: usize, na: i32, bPtr: usize, nb: i32): i32 {
 ...
 * @returns New length of set
 */
export function setRemove(aPtr: usize, n: i32, value: f64, resultPtr: usize): i32 {
  if (n === 0) return 0;
 ...
 */
export function setCartesian(aPtr: usize, na: i32, bPtr: usize, nb: i32, resultPtr: usize): i32 {
  if (na === 0 || nb === 0) return 0;
 ...
 */
export function setGetSubset(aPtr: usize, n: i32, index: i32, resultPtr: usize): i32 {
  let k: i32 = 0;
