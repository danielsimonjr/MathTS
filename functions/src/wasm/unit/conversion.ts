 ...
 * @param resultPtr Pointer to output dimension vector (7 f64s)
 */
export function multiplyDimensions(dims1Ptr: usize, dims2Ptr: usize, resultPtr: usize): void {
  for (let i: i32 = 0; i < NUM_DIMENSIONS; i++) {
    const offset: usize = (<usize>i) << 3;
 ...
 * @param resultPtr Pointer to output dimension vector (7 f64s)
 */
export function divideDimensions(dims1Ptr: usize, dims2Ptr: usize, resultPtr: usize): void {
  for (let i: i32 = 0; i < NUM_DIMENSIONS; i++) {
    const offset: usize = (<usize>i) << 3;
    store<f64>(resultPtr + offset, load<f64>(dims1Ptr + offset) - load<f64>(dims2Ptr + offset));
  }
 ...
 * @param resultPtr Pointer to output dimension vector (7 f64s)
 */
export function powerDimensions(dimsPtr: usize, power: f64, resultPtr: usize): void {
  for (let i: i32 = 0; i < NUM_DIMENSIONS; i++) {
    const offset: usize = (<usize>i) << 3;
