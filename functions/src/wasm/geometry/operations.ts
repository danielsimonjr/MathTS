 ...
 * @returns The distance
 */
export function distance3D(x1: f64, y1: f64, z1: f64, x2: f64, y2: f64, z2: f64): f64 {
  const dx: f64 = x2 - x1;
  const dy: f64 = y2 - y1;
  const dz: f64 = z2 - z1;
 ...
 * @returns The angle in radians
 */
export function angle3D(x1: f64, y1: f64, z1: f64, x2: f64, y2: f64, z2: f64): f64 {
 ...
 */
export function triangleArea2D(x1: f64, y1: f64, x2: f64, y2: f64, x3: f64, y3: f64): f64 {
 ...
 */
export function distancePointToLine2D(px: f64, py: f64, x1: f64, y1: f64, x2: f64, y2: f64): f64 {
  const dx: f64 = x2 - x1;
  const dy: f64 = y2 - y1;
 ...
 * @returns 1.0 if inside, 0.0 if outside
 */
export function pointInConvexPolygon2D(px: f64, py: f64, verticesPtr: usize, n: i32): f64 {
  if (n < 3) {
    return 0.0;
  }
