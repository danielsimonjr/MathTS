 ...
 * @param resultPtr Pointer to store 2 i64 values [numerator, denominator]
 */
export function add(num1: i64, den1: i64, num2: i64, den2: i64, resultPtr: usize): void {
 ...
 * @param resultPtr Pointer to store 2 i64 values [numerator, denominator]
 */
export function subtract(num1: i64, den1: i64, num2: i64, den2: i64, resultPtr: usize): void {
 ...
 * @param resultPtr Pointer to store 2 i64 values [numerator, denominator]
 */
export function multiply(num1: i64, den1: i64, num2: i64, den2: i64, resultPtr: usize): void {
 ...
 * @param resultPtr Pointer to store 2 i64 values [numerator, denominator]
 */
export function divide(num1: i64, den1: i64, num2: i64, den2: i64, resultPtr: usize): void {
 ...
 * @param resultPtr Pointer to store 2 i64 values [numerator, denominator]
 */
export function mod(num: i64, den: i64, n: i64, workPtr: usize, resultPtr: usize): void {
  if (n === 0) {
    store<i64>(resultPtr, num);
    store<i64>(resultPtr + 8, den);
    return;
 ...
 */
export function sumArray(rationalsPtr: usize, count: i32, resultPtr: usize): void {
  if (count === 0) {
    store<i64>(resultPtr, 0);
    store<i64>(resultPtr + 8, 1);
    return;
 ...
 */
export function productArray(rationalsPtr: usize, count: i32, resultPtr: usize): void {
  if (count === 0) {
    store<i64>(resultPtr, 1);
    store<i64>(resultPtr + 8, 1);
    return;
 ...
 */
export function toContinuedFraction(num: i64, den: i64, maxTerms: i32, resultPtr: usize): i32 {
  let count: i32 = 0;
 ...
 * @param resultPtr Pointer to store 2 i64 values [numerator, denominator]
 */
export function fromContinuedFraction(termsPtr: usize, n: i32, resultPtr: usize): void {
  if (n === 0) {
    store<i64>(resultPtr, 0);
    store<i64>(resultPtr + 8, 1);
    return;
 ...
 * @param resultPtr Pointer to store 2 i64 values [numerator, denominator]
 */
export function mediant(num1: i64, den1: i64, num2: i64, den2: i64, resultPtr: usize): void {
 ...
 * @param resultPtr Pointer to store 2 i64 values [numerator, denominator]
 */
export function bestApproximation(value: f64, maxDenom: i64, resultPtr: usize): void {
  if (!isFinite(value)) {
    store<i64>(resultPtr, value > 0 ? 1 : value < 0 ? -1 : 0);
    store<i64>(resultPtr + 8, 0);
    return;
 ...
 * @param resultPtr Pointer to store 2 f64 values [numerator, denominator]
 */
export function addF64(num1: f64, den1: f64, num2: f64, den2: f64, resultPtr: usize): void {
 ...
 * @param resultPtr Pointer to store 2 f64 values [numerator, denominator]
 */
export function multiplyF64(num1: f64, den1: f64, num2: f64, den2: f64, resultPtr: usize): void {
  // Cross-reduce to minimize overflow
 ...
 * @param resultPtr Pointer to store 2 f64 values [numerator, denominator]
 */
export function fromFloatF64(value: f64, maxDenom: f64, resultPtr: usize): void {
  if (!isFinite(value)) {
