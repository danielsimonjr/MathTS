 ...
 * @returns Approximate derivative
 */
export function fivePointStencil(fxp2h: f64, fxph: f64, fxmh: f64, fxm2h: f64, h: f64): f64 {
  if (h === 0) return f64.NaN;
 ...
 */
export function hessian(fValuesPtr: usize, fx: f64, h: f64, n: i32, resultPtr: usize): void {
  const h2: f64 = h * h;
 ...
 */
export function gaussLegendreWeights(a: f64, b: f64, nPoints: i32, resultPtr: usize): i32 {
  const halfWidth: f64 = (b - a) / 2.0;
 ...
 * @returns Approximate integral
 */
export function gaussLegendre(fValuesPtr: usize, weightsPtr: usize, nPoints: i32): f64 {
  let sum: f64 = 0.0;
