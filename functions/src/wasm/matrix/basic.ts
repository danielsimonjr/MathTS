 ...
 * @returns Number of diagonal elements extracted
 */
export function diagK(aPtr: usize, rows: i32, cols: i32, k: i32, resultPtr: usize): i32 {
  let n: i32;
  let startRow: i32;
  let startCol: i32;
 ...
 */
export function getColumn(aPtr: usize, rows: i32, cols: i32, col: i32, resultPtr: usize): void {
 ...
 */
export function setRow(aPtr: usize, cols: i32, row: i32, valuesPtr: usize): void {
  const offset: i32 = row * cols;
  for (let j: i32 = 0; j < cols; j++) {
 ...
 */
export function setColumn(aPtr: usize, rows: i32, cols: i32, col: i32, valuesPtr: usize): void {
  for (let i: i32 = 0; i < rows; i++) {
 ...
 */
export function swapColumns(aPtr: usize, rows: i32, cols: i32, col1: i32, col2: i32): void {
  for (let i: i32 = 0; i < rows; i++) {
 ...
 */
export function dotMultiply(aPtr: usize, bPtr: usize, size: i32, resultPtr: usize): void {
  for (let i: i32 = 0; i < size; i++) {
 ...
 */
export function dotDivide(aPtr: usize, bPtr: usize, size: i32, resultPtr: usize): void {
  for (let i: i32 = 0; i < size; i++) {
    const offset: usize = (<usize>i) << 3;
    store<f64>(resultPtr + offset, load<f64>(aPtr + offset) / load<f64>(bPtr + offset));
  }
 ...
 */
export function dotPow(aPtr: usize, bPtr: usize, size: i32, resultPtr: usize): void {
  for (let i: i32 = 0; i < size; i++) {
    const offset: usize = (<usize>i) << 3;
...
export function sumCols(aPtr: usize, rows: i32, cols: i32, resultPtr: usize): void {
  ...
  for (let i: i32 = 0; i < rows; i++) {
    for (let j: i32 = 0; j < cols; j++) {
      ...
      store<f64>(
        resultPtr + jOffset,
        load<f64>(resultPtr + jOffset) + load<f64>(aPtr + ((<usize>(i * cols + j)) << 3))
      );
    }
  }
}
