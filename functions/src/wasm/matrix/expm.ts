 ...
 */
export function expm(matrixPtr: usize, n: i32, resultPtr: usize, workPtr: usize): i32 {
  const nn: i32 = n * n;
  const eps: f64 = 1e-15;
 ...
 */
export function expmSmall(matrixPtr: usize, n: i32, resultPtr: usize, numTerms: i32): void {
  const nn: i32 = n * n;
