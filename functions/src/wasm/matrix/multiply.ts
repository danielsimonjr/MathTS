 ...
 */
export function transpose(aPtr: usize, rows: i32, cols: i32, resultPtr: usize): void {
 ...
 */
export function add(aPtr: usize, bPtr: usize, size: i32, resultPtr: usize): void {
 ...
 * @param resultPtr - Pointer to result matrix C
 */
export function subtract(aPtr: usize, bPtr: usize, size: i32, resultPtr: usize): void {
  for (let i: i32 = 0; i < size; i++) {
    const offset: usize = (<usize>i) << 3;
    store<f64>(resultPtr + offset, load<f64>(aPtr + offset) - load<f64>(bPtr + offset));
  }
 ...
 */
export function scalarMultiply(aPtr: usize, scalar: f64, size: i32, resultPtr: usize): void {
  for (let i: i32 = 0; i < size; i++) {
    const offset: usize = (<usize>i) << 3;
        ...
        for (let i: i32 = ii; i < iEnd; i++) {
          ...
          for (let j: i32 = jj; j < jEnd; j++) {
            ...
            if (useBt) {
              ...
              for (; k < kEnd; k++) {
                sum +=
                  load<f64>(aRowPtr + ((<usize>k) << 3)) * load<f64>(btColPtr + ((<usize>k) << 3));
              }
            } else {
 ...
 */
export function addSIMD(aPtr: usize, bPtr: usize, size: i32, resultPtr: usize): void {
  let i: i32 = 0;
 ...
 * @param resultPtr - Pointer to result
 */
export function subtractSIMD(aPtr: usize, bPtr: usize, size: i32, resultPtr: usize): void {
  let i: i32 = 0;
  const limit: i32 = size - 1;
 ...
 * @param resultPtr - Pointer to result
 */
export function scalarMultiplySIMD(aPtr: usize, scalar: f64, size: i32, resultPtr: usize): void {
 ...
 */
export function transposeSIMD(aPtr: usize, rows: i32, cols: i32, resultPtr: usize): void {
