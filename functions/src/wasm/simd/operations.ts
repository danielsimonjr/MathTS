 ...
 */
export function simdAddF64(aPtr: usize, bPtr: usize, resultPtr: usize, length: i32): void {
 ...
 */
export function simdSubF64(aPtr: usize, bPtr: usize, resultPtr: usize, length: i32): void {
 ...
 */
export function simdMulF64(aPtr: usize, bPtr: usize, resultPtr: usize, length: i32): void {
  const simdLength = length & ~1;
 ...
 */
export function simdDivF64(aPtr: usize, bPtr: usize, resultPtr: usize, length: i32): void {
  const simdLength = length & ~1;
 ...
 */
export function simdScaleF64(aPtr: usize, scalar: f64, resultPtr: usize, length: i32): void {
  const simdLength = length & ~1;
 ...
 */
export function simdAbsF64(aPtr: usize, resultPtr: usize, length: i32): void {
  const simdLength = length & ~1;
 ...
 */
export function simdSqrtF64(aPtr: usize, resultPtr: usize, length: i32): void {
  const simdLength = length & ~1;
 ...
 */
export function simdNegF64(aPtr: usize, resultPtr: usize, length: i32): void {
  const simdLength = length & ~1;
 ...
 */
export function simdMatVecMulF64(APtr: usize, xPtr: usize, resultPtr: usize, m: i32, n: i32): void {
  const simdN = n & ~1;
 ...
 */
export function simdMatAddF64(APtr: usize, BPtr: usize, CPtr: usize, m: i32, n: i32): void {
  const total = m * n;
 ...
 */
export function simdMatSubF64(APtr: usize, BPtr: usize, CPtr: usize, m: i32, n: i32): void {
  const total = m * n;
 ...
 */
export function simdMatDotMulF64(APtr: usize, BPtr: usize, CPtr: usize, m: i32, n: i32): void {
  const total = m * n;
 ...
 */
export function simdMatScaleF64(APtr: usize, scalar: f64, BPtr: usize, m: i32, n: i32): void {
  const total = m * n;
 ...
 */
export function simdMatMulF64(APtr: usize, BPtr: usize, CPtr: usize, m: i32, k: i32, n: i32): void {
  const simdK = k & ~1;
 ...
 */
export function simdMatTransposeF64(APtr: usize, BPtr: usize, m: i32, n: i32): void {
  ...
  for (let i: i32 = m2; i < m; i++) {
    for (let j: i32 = 0; j < n; j++) {
      store<f64>(BPtr + ((<usize>(j * m + i)) << 3), load<f64>(APtr + ((<usize>(i * n + j)) << 3)));
    }
  }
 ...
 */
export function simdVarianceF64(aPtr: usize, length: i32, ddof: i32 = 0): f64 {
 ...
 */
export function simdAddF32(aPtr: usize, bPtr: usize, resultPtr: usize, length: i32): void {
 ...
 */
export function simdMulF32(aPtr: usize, bPtr: usize, resultPtr: usize, length: i32): void {
 ...
 */
export function simdAddI32(aPtr: usize, bPtr: usize, resultPtr: usize, length: i32): void {
  const simdLength = length & ~3;
 ...
 */
export function simdMulI32(aPtr: usize, bPtr: usize, resultPtr: usize, length: i32): void {
  const simdLength = length & ~3;
 ...
 */
export function simdComplexMulF64(aPtr: usize, bPtr: usize, resultPtr: usize, count: i32): void {
 ...
 */
export function simdComplexAddF64(aPtr: usize, bPtr: usize, resultPtr: usize, count: i32): void {
