/**
 * Frozen snapshot of `functions/src/utils/collection.ts` as it stood at the commit
...
} from './functions-array-original.js';
import { _switch } from './functions-switch-original.js';
