/**
 * Frozen snapshot of `functions/src/utils/array.ts` as it stood at the commit
 * BEFORE the Bucket B slice 2 redirect (`git show HEAD:functions/src/utils/array.ts`),
 ...
 * import paths below were adjusted (fixture moved one directory deeper); the
 * function bodies are untouched. Do not import this file from `src/`.
 */
import { isInteger } from '../../../src/utils/number.js';
import {
  isNumber,
  isBigNumber,
  isArray,
