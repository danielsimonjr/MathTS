/**
 * Frozen snapshot of `functions/src/utils/map.ts` as it stood at the commit
 * BEFORE the Bucket B slice 2 redirect. See `functions-array-original.ts`'s header.
 */
import { getSafeProperty, isSafeProperty, setSafeProperty } from '../../../src/utils/customs.js';
import { isMap, isObject } from '../../../src/utils/is.js';
 ...
 */
export function createEmptyMap<K = unknown, V = unknown>(): Map<K, V> {
  return new Map<K, V>();
}
