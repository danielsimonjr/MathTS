/**
 * Frozen snapshot of `expression/src/utils/collection.ts` as it stood at the
 * commit BEFORE the Bucket B slice 2 redirect. See `expression-array-original.ts`'s
 * header.
 */
...
} from './expression-array-original.js';
import { _switch } from './expression-switch-original.js';
