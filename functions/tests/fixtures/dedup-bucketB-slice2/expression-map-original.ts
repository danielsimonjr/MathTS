/**
 * Frozen snapshot of `expression/src/utils/map.ts` as it stood at the commit
 * BEFORE the Bucket B slice 2 redirect. See `expression-array-original.ts`'s header.
 */
import {
  getSafeProperty,
  isSafeProperty,
  setSafeProperty,
} from '../../../../expression/src/utils/customs.js';
import { isMap, isObject } from '../../../../expression/src/utils/is.js';
