...
const DOMAIN_SUPPLEMENT = {
  ...
  Statistics: [
    ...
    'ewma', 'gmean', 'hmean', 'iqr', 'kurtosis', 'kmeans', 'logsumexp', 'moment',
    'movingAverage', 'rankdata', 'sem', 'skewness', 'softmax', 'spectralClustering',
  ...
  'Probability Distributions': [
    ...
    'gammaQuantile', 'laplaceCDF', 'laplacePDF', 'laplaceQuantile', 'logisticCDF',
    'logisticPDF', 'logisticQuantile', 'noncentralChi2PDF', 'normalQuantile',
    'studentTCDF', 'studentTPDF', 'studentTQuantile', 'studentizedRangeCDF',
    'studentizedRangeQuantile', 'seedProbabilityRng',
  ],
  'Hypothesis Tests': ['fTest', 'fisherExact', 'jarqueBera', 'kruskalWallis', 'tukeyHSD', 'wilcoxon'],
  'Signal Processing': [
  ...
  'Type Checking & Utilities': ['fuseUnaryChain', 'help', 'validateClosureSource'],
