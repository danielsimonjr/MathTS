...
const DOMAIN_SUPPLEMENT = {
  ...
  Statistics: [
    'acf', 'corrcoef', 'cov', 'cummax', 'cummin', 'cumprod', 'cumtrapz', 'detrend',
    'ewma', 'gmean', 'hmean', 'iqr', 'kendallTau', 'kurtosis', 'kmeans', 'logsumexp',
    'moment', 'movingAverage', 'rankdata', 'sem', 'skewness', 'softmax',
    'spectralClustering', 'zscore', 'linearRegression', 'parallelStatPercentile',
  ],
  'Probability Distributions': [
    'betaCDF', 'betaPDF', 'betaQuantile', 'cauchyCDF', 'cauchyPDF', 'cauchyQuantile',
    'chiSquaredCDF', 'chiSquaredQuantile', 'fCDF', 'fQuantile', 'gammaCDF', 'gammaPDF',
    'gammaQuantile', 'hypergeometricDist', 'laplaceCDF', 'laplacePDF', 'laplaceQuantile',
    'logisticCDF', 'logisticPDF', 'logisticQuantile', 'negativeBinomialDist',
    'noncentralChi2PDF', 'normalQuantile', 'studentTCDF', 'studentTPDF', 'studentTQuantile',
    'studentizedRangeCDF', 'studentizedRangeQuantile', 'seedProbabilityRng',
  ],
  'Hypothesis Tests': [
    'bartlettTest', 'binomialTest', 'fTest', 'fisherExact', 'jarqueBera',
    'kolmogorovSmirnov2Test', 'kruskalWallis', 'leveneTest', 'proportionZTest',
    'studentTTestPaired', 'tukeyHSD', 'wilcoxon',
  ],
  'Signal Processing': [
